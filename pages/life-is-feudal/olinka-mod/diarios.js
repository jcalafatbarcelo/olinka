    ...
    return (
        <>
            ...
            <div>
                ...
                <main>
                    <CabeceraH1 clase={`bg-header-olinka`} titulo={`Diarios de Encargos`} subtitulo={`Olinka MOD`}></CabeceraH1>
                   
                    <div className="center_block clear_down">
                        <p>Los Diarios de encargos son los objetos que se usarán para la creación de los Packs, los objetos especiales y las Licencias de obra</p>
...
{
    const response = await fetch( 'http://localhost:3000/api/recetas/tools' )
